...
These hacks spread over the air (airborne) and don't even require attackers to pair with the targeted device, and can work even if the device is not in discoverable mode!
